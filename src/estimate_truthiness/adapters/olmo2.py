...
class OLMo2Adapter(ModelAdapter):
    """Adapter for allenai/OLMo-2-1124-7B.

    OLMo 2 uses the same SentencePiece tokenization as OLMo 3 (▁ space markers).
    Provided as a comparison baseline for studying how distributions changed
    between OLMo generations.
    """
    ...
    def model_name(self) -> str:
        return "OLMo 2 7B (allenai/OLMo-2-1124-7B)"
